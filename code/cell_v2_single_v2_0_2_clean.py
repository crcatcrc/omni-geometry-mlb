...
# ============================================================================
# v2.0 SINGLE-FEATURE RUN
# ----------------------------------------------------------------------------
# Edit BASE_FILE, ASPECT_FILE, FEATURE_NAME below. Output goes to OUTPUT_DIR.
# Re-run uses include validating that v1.5 Phase A locks reproduce exactly.
# ============================================================================
