...
# ============================================================================
# v2.0 BATCH RUN — production mode
# ----------------------------------------------------------------------------
...
BASE_FILE     = '/content/MLB 2000 - no02-2024 Combined Calcd Positions.csv'
ASPECT_FILE   = '/content/MLB 2000-no02-2024 G-LON to G-LON aspect features.csv'
OUTPUT_DIR    = Path('/content/omni_phase_v2')
