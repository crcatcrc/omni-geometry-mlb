...
2026-05-09 — EA batch complete and locked. Nine chunks executed under engine v2.0.2: EA-1 (G-LON same), EA-2 (G-RA same), EA-3 (G-AZ same, concentration), EA-4 (G-LON × G-RA), EA-5 (G-RA × G-LON), EA-6 (G-LON × G-AZ), EA-7 (G-AZ × G-LON, concentration), EA-8 (G-RA × G-AZ), EA-9 (G-AZ × G-RA, concentration). Panel-wide H1 support 232/294 = 78.9%. Coverage-clean detection robustness 222/222. Phase B 7-block anchor+persistent 245/294 = 83.3%. Within-origin regime split: global 180/204 = 88.2%, concentration 65/90 = 72.2% — first within-origin demonstration that concentration trades higher Phase A support for lower temporal stability. New cross-origin structural law (Statement EA-8): target-G-AZ sparse-outer suppression converges across all four origins (Asc/MC/VX/EA), establishing it as a property of the measurement system rather than origin-specific. EA Batch Summary v1.1-final cross-reviewed with ChatG (parallel summary produced; key contributions incorporated) and locked. Cleared to begin MO batch.

2026-05-09 — MO batch complete and locked. Nine chunks executed under engine v2.0.2: MO-1 (G-LON same), MO-2 (G-RA same), MO-3 (G-AZ same), MO-4 (G-LON × G-RA), MO-5 (G-RA × G-LON), MO-6 (G-LON × G-AZ), MO-7 (G-AZ × G-LON), MO-8 (G-RA × G-AZ), MO-9 (G-AZ × G-RA). MO is global-regime in all 9 chunks; PFff/PFdn excluded by algebraic degeneracy with MO; 14 testable bodies × 9 × 2 = 252 evaluations. Panel-wide H1 support 252/252 = 100.0% — first complete-support origin batch in Phase 1. Phase B 7-block: 252/252 anchor (zero persistent, zero fragile); 5-block: 252/252 anchor; 3-block: 248 anchor + 4 persistent. All body classes 100% supported including constrained-inner (54/54) and sparse-outer (54/54). Statement MO-7 closes the coverage-mismatch interpretation: the failure mechanisms documented across Asc/MC/VX/EA are geometric properties of those origins' coverage interaction with the 360° measurement system, not properties of the underlying signal. MO Batch Summary v1.1-final cross-reviewed with ChatG and locked. Cleared to begin ME batch — closes Phase 1.

2026-05-09 — ME batch complete and locked. Phase 1 closes. Nine chunks executed under engine v2.0.2: ME-1 (G-LON same), ME-2 (G-RA same), ME-3 (G-AZ same), ME-4 (G-LON × G-RA), ME-5 (G-RA × G-LON), ME-6 (G-LON × G-AZ), ME-7 (G-AZ × G-LON), ME-8 (G-RA × G-AZ), ME-9 (G-AZ × G-RA). MO/PFff/PFdn excluded by faster-to-slower convention; 13 testable bodies × 9 × 2 = 234 evaluations. Panel-wide H1 support 176/234 = 75.2%. Coverage-clean classes (Tier A, B, C) 144/144 = 100%; elongation-bound (VE, SU) 23/36 = 63.9% Phase A but 32/36 = 88.9% under 7-block; sparse-outer 8/54 = 14.8% Phase A and 10/54 = 18.5% 7-block (zero anchor classifications, lowest in Phase 1). Statement ME-3 establishes the formal distinction between projection-sensitive occupancy distortion (elongation-bound mode) and time-domain occupancy deficit (seasonal-zodiac-gap mode). Statement ME-4 provides the empirical demonstration that overdense saturation and sparse-collapse are symmetric boundary failure modes of the count-and-lift framework. Statement ME-7 closes Phase 1 with the cross-origin synthesis that the framework both detects stable structures and differentiates classes of instability. ME Batch Summary v1.1-final cross-reviewed with ChatG and locked. Phase 1 complete: 1,482 evaluations across six origin batches, exact match to pre-registered adjusted scope. Cleared to begin Phase 1.5 spectral / harmonic analysis on the locked per-feature smoothed_360 data.

Save to GitHub omni-geometry-mlb/docs/ as ME_Batch_Summary_v1_1_final.docx and append the entry above to experiment_log.md. Phase 1 done.Me batch summary v1 1 finalDocument · DOCX Download

2026-05-10 — Phase 1.5 Pre-Registration locked. Document v1.1-final completed and OSF-registered following ChatG hostile-review sign-off. Three-stage gated architecture (1.5A calibration → 1.5B cross-origin → 1.5C full-panel) with five locked test statistics, two null families (Family A moving-block bootstrap as primary for amplitude tests; Family B phase randomization for phase tests), three-method omnibus combination (HMP + Fisher + Stouffer), FDR q=0.01 primary inference, comprehensive confounder pre-registration, frame-invariance test as spectral bridge to Phase 1's detection-vs-localization principle. Three-state advancement taxonomy (primary inferential / secondary exploratory / no confirmatory escalation) replaces binary pass/fail. Conservative cross-stage rule: primary confirmatory escalation requires primary support at all three stages. Reporting policy locked for all three outcome paths regardless of outcome. Phase 1.5A locked feature set: 10 MO-1 Tier A features (MO × MA / VS / PA / JN / CE in G-LON same-coord, both High and Low). Cleared to begin Phase 1.5A execution.
